...
const Contact = () => {
  ...
  },
  {
    ...
    icon:
    <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.96-.065-1.186.408-2.228 1.33-2.934.868-.663 2.082-1.04 3.514-1.093 1.079-.04 2.085.07 3.003.305-.146-.742-.449-1.32-.908-1.727-.545-.483-1.332-.727-2.341-.744h-.064c-.752 0-1.673.217-2.32.6l-1.04-1.695c.96-.567 2.17-.874 3.36-.874h.09c3.236.042 5.052 2.106 5.395 4.647.18.048.357.1.528.157 1.2.396 2.155 1.072 2.84 2.01.87 1.192 1.174 2.7.858 4.248-.438 2.147-1.884 3.89-4.07 4.903-1.663.77-3.652 1.166-5.907 1.178zM12.39 13.86c-.93.035-1.678.26-2.165.652-.404.325-.583.726-.556 1.227.04.705.552 1.525 2.074 1.512h.014c1.07-.057 1.852-.47 2.393-1.266.368-.543.621-1.258.734-2.14-.817-.206-1.696-.322-2.494-.286v.001z" />
        </svg>,
    url: "https://www.threads.com/@officialbrandorbit",
    color: "from-gray-800 to-gray-900",
